...
public class HelloWorld extends PApplet
{
	...
	ArrayList<UnfoldingMap> maps = new ArrayList<>();
	...
	public void setup() {
		...
		GoogleMapProvider google = new Google.GoogleMapProvider();
		// Set a zoom level
		int zoomLevel = 10;
		...
		map2.zoomAndPanTo(zoomLevel,new Location(42.3145186f,-71.1103695f));
